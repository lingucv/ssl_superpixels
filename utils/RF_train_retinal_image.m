function forest_sp = RF_train_retinal_image(img,...
    label_img,mask_img,pTrain_sp,p)

% train a forest based on the given annotation 
...
% now collect the image features
...
% now prepare the training labels

labels = label_img(idx_img) + 1;

forest_sp = forestTrain(img_ftrs,labels,...
    pTrain_sp{:});
