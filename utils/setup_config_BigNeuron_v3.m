function p = setup_config_BigNeuron_v3
...
data_dir = '..\Data\Gold49\BigN\';

gt_dir = '..\Data\Gold49\BigNGT\';


% randomly split the data into the training and testing set

file_list = dir([gt_dir '*.tif']);

file_order = randperm(length(file_list));

trn_img_order = file_order(1:4);

tst_img_order = file_order(1:end);
